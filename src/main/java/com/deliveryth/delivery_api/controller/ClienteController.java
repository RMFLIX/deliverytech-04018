...
public class ClienteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<com.deliveryth.delivery_api.dto.responses.ApiResponse<ClienteResponseDTO>> buscarPorId(@PathVariable Long id){
        return ResponseEntity.ok().header("Content-Type", "application/json").body(new com.deliveryth.delivery_api.dto.responses.ApiResponse<>( service.buscarPorId(id)));
    }
