...
public class RestauranteController { 
    ...
    @PostMapping 
    public ResponseEntity<com.deliveryth.delivery_api.dto.responses.ApiResponse<RestauranteResponseDTO>> cadastrar(@Valid @RequestBody RestauranteDTO dados) {
    ...
    public ResponseEntity<com.deliveryth.delivery_api.dto.responses.ApiResponse<RestauranteResponseDTO>> buscarPorId(@PathVariable Long id) { 
        return ResponseEntity.ok() 
        .header("Content-Type", "application/json") 
        .body(new com.deliveryth.delivery_api.dto.responses.ApiResponse<>(service.buscarPorId(id))); 
    } 
    ...
    public ResponseEntity<PagedResponse<RestauranteResponseDTO>> buscarPorCategoria( 
        ...
        public ResponseEntity<com.deliveryth.delivery_api.dto.responses.ApiResponse<RestauranteResponseDTO>> toggle(@PathVariable Long id) {
            return ResponseEntity.ok()
                   .header("Content-Type", "application/json")
                   .body(new com.deliveryth.delivery_api.dto.responses.ApiResponse<>(service.toggle(id)));
        }
    }